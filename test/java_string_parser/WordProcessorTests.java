...
public class WordProcessorTests
{
	...
	{
		Assert.assertEquals(0, this.processor.getDelimiters().size());
	}
	
	@Test
	public void getSource_SourceIsNotSet_ReturnsEmptyArray()
	{
		Assert.assertEquals(0, this.processor.getSource().size());
	}
	...
	public void getWordsWithMaxLength_ReturnsValidList()
	{
		...
		Assert.assertEquals(new HashSet<String>(wordsList),
	...
	{
		Assert.assertEquals(0, this.processor.getWordsWithMaxLength().size());
	}
	...
	public void processWords_SourceContainsOnlyFromDelimiters_WordsListWillBeEmpty()
	{
		...
		Assert.assertEquals(0, this.processor.getWords().size());
	}
